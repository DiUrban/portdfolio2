            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                ...
                children: projects?.map((project, i)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                className: "space-y-2 px-0 md:px-10 w-full mx-auto flex-shrink-0",
                                children: [
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("h4", {
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                        className: "flex w-2/3 max-w-6xl mx-auto",
                                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                            className: "text-lg text-justify inter-word max-sm:text-base max-w-6xl",
...
const fetchSkills = async ()=>{
    const res = await fetch(`${"https://www.emrani.co.uk"}/api/getSkills`);
...
const fetchSocials = async ()=>{
    const res = await fetch(`${"https://www.emrani.co.uk"}/api/getSocials`);
    const data = await res.json();
...
const fetchProjects = async ()=>{
    const res = await fetch(`${"https://www.emrani.co.uk"}/api/getProjects`);
    const data = await res.json();
...
const fetchPageInfo = async ()=>{
    const res = await fetch(`${"https://www.emrani.co.uk"}/api/getPageInfo`);
    const data = await res.json();
...
const fetchExperiences = async ()=>{
    const res = await fetch(`${"https://www.emrani.co.uk"}/api/getExperiences`);
    const data = await res.json();
